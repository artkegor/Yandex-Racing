...
class MainMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.draw_text("Options", 40, (255, 255, 255), self.game.DISPLAY_W / 2,
                           self.game.DISPLAY_H / 2 + self.newline)
            self.draw_text("Credits", 40, (255, 255, 255), self.game.DISPLAY_W / 2,
                           self.game.DISPLAY_H / 2 + 2 * self.newline)
            self.draw_cursor()
